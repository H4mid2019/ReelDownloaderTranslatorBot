...
print(f"⏱️ Duration: {result.duration_seconds:.1f}s" if result.duration_seconds else "⏱️ Duration: N/A")
...
print(f"✅ PASS: File size {actual_mb:.2f} MB is optimal (under {MAX_EXPECTED_MB}MB limit).")
